...
class Parser implements SingletonInterface
{
    ...
    const UPLOAD_DIR_PICTURE = '/home/c/cv24440/HLSP/public_html/upload/parser_news_tmp/';
    ...
    {
        $this->dateHelper = new \HLSP\Helper\DateHelper;
        $this->stringHelper = new \HLSP\Helper\StringHelper;
    }
